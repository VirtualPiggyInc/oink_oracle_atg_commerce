    <%-- This page shows Virtual Piggy Child selection options to logged in Virtual Piggy Parent. --%>
        ...
        <cbp:pageContainer index="false"
        follow="false" bodyClass="atg_store_pageLogin atg_store_checkout">
        <cbp:checkoutContainer currentStage="">
        <jsp:body>
            ...
            <dsp:getvalueof var="vpSelectedChildId" vartype="java.lang.String"
            bean="/atg/userprofiling/Profile.virtualPiggySelectedChildId"/>

            <dsp:form id="atg_store_checkoutSelVPChildForm" formid="vpSelChild" action="${originatingRequest.requestURI}
            " method="post">
            <%-- loop over the list--%>
            ...
            <br/>
            <div align="center">
            <dsp:input type="checkbox" bean="ProfileFormHandler.value.virtualPiggyParentShipAddressSelection"
            value="false" checked="false"></dsp:input>
            ...
            <dsp:input bean="ProfileFormHandler.selectVirtualPiggyChildErrorURL" type="hidden"
